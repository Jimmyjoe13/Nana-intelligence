...
import { campaignsData, campaignDetail } from "@/mocks/campaigns";
import { Plus, ArrowLeft, MoreHorizontal, ExternalLink, Users } from "lucide-react";
      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <Box className="lg:col-span-2 flex flex-col gap-6">
            ...
            <LineChart data={campaign.chartData} height={300} />
          </Box>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-1">
                ...
                <span className="text-sm font-medium flex items-center gap-2">
                  S03 - Cold Outreach Tech <ExternalLink size={12} className="text-orange" />
                </span>
              </div>
              <div className="flex flex-col gap-1">
                <span className="font-mono text-[10px] text-ink-4 uppercase">BASE UTILISÉE</span>
                <span className="text-sm font-medium">List_ESN_75 (850 prospects)</span>
              </div>
              <div className="flex flex-col gap-1">
        ...
        <div className="border-[1.5px] border-ink bg-cream overflow-hidden">
          ...
          <table className="w-full text-left border-collapse">
            <tbody>
              {campaign.prospects.map((prospect, index) => (
          ...
          <tbody>
            {campaignsData.map((camp) => (
              <tr 
                ...
                onClick={() => setViewingCampaign(camp.id)}
              >
                ...
                <td className="px-6 py-5 font-mono text-[11px] text-ink-4 uppercase">{camp.startedAt}</td>
                <td className="px-6 py-5">
