...
export const agenciesData: Record<string, AgencyData> = {
  marseille: {
    ...
    metaDescription: "Agence de prospection commerciale B2B à Marseille. Cold Emailing & Scraping sur-mesure pour remplir votre agenda de décideurs qualifiés. Résultats dès 15 jours — Audit stratégique de 30 min offert.",
    detailedContent: [
  ...
  "aix-en-provence": {
    ...
    metaTitle: "Prospection B2B Aix-en-Provence — Décideurs C-Level | Audit Gratuit",
    metaDescription: "Agence de prospection B2B à Aix-en-Provence & Pays d'Aix. Ciblez les décideurs C-Level avec le Cold Emailing haute délivrabilité. Modèle à la performance — Audit stratégique 30 min offert.",
    detailedContent: [
  ...
  toulon: {
    ...
    metaDescription: "Agence de prospection commerciale B2B à Toulon et dans le Var. Générez un flux de RDV qualifiés avec des décideurs ciblés. Rémunération à la performance — Audit 30 min offert.",
    detailedContent: [
  ...
  nice: {
    ...
    metaTitle: "Prospection B2B Nice & Sophia Antipolis — Leads Qualifiés | Audit Gratuit",
    metaDescription: "Agence de prospection B2B à Nice, Sophia Antipolis & Côte d'Azur. Cold Emailing ciblé pour startups Tech & PME. Résultats mesurables dès 15 jours — Audit stratégique 30 min offert.",
    detailedContent: [
