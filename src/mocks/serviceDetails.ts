...
export const serviceDetails: Record<string, ServiceDetail> = {
  "cold-emailing-b2b": {
    ...
    metaTitle: "Cold Emailing B2B : Générez des RDV Qualifiés en 15 Jours",
    metaDescription: "Agence cold emailing B2B : SPF/DKIM/DMARC, copywriting de conversion et relances automatisées pour un flux de RDV qualifiés en 15 jours. Audit offert.",
  ...
  "scraping-b2b": {
    ...
    detailedContent: [
      ...
      "Nous extrayons les données là où se trouvent vos prospects : sur LinkedIn et Sales Navigator pour cibler par fonction, secteur, effectif et technologie utilisée, et sur Google Maps pour les approches géolocalisées (commerces, agences, artisans, entreprises locales). Notre infrastructure de scraping sur-mesure est conçue pour collecter à grande échelle tout en respectant scrupuleusement les limitations techniques des plateformes.",
      "L'extraction brute de données n'est que la première étape du processus. Chaque contact extrait passe par un pipeline d'enrichissement rigoureux : recherche de l'email professionnel nominatif (prenom.nom@domaine.com), vérification en temps réel par ping SMTP direct (pour éliminer 99% des adresses invalides et éviter les 'bounces'), et complétion des informations d'entreprise (code NAF, effectif réel, chiffre d'affaires, réseaux sociaux).",
      "Nous dédupliquons et nettoyons la base de données pour vous livrer un fichier directement exploitable, segmenté selon vos critères exacts de ciblage. Que vous souhaitiez contacter les Directeurs Marketing des PME du secteur logiciel ou les gérants de commerces indépendants en région PACA, notre donnée garantit un taux de délivrabilité maximal et protège vos domaines d'envoi.",
      "Conformité RGPD et Législation : Le scraping B2B est parfaitement encadré en France et en Europe. Nous ne collectons exclusivement que des données professionnelles publiques et nous appuyons sur l'intérêt légitime de la prospection commerciale B2B. Chaque campagne intègre systématiquement la possibilité pour les prospects de s'opposer au traitement de leurs données.",
      "Cette donnée de haute précision constitue le carburant indispensable de vos campagnes de cold emailing. Un ciblage hyper-spécifique permet de rédiger des messages ultra-personnalisés qui génèrent jusqu'à 3x plus de réponses qu'un emailing de masse. Pour les équipes autonomes avec des besoins récurrents, notre outil en ligne Spider permet de scraper et d'enrichir à la demande sans abonnement engageant. Découvrez également notre accompagnement SEO pour capter de la demande entrante en complément de l'Outbound.",
    ],
    relatedCities: [
      { slug: "marseille", label: "Marseille" },
      { slug: "aix-en-provence", label: "Aix-en-provence" },
  ...
  "accompagnement-seo": {
    ...
    features: [
      ...
      "Rédaction d'articles de blog & pages piliers",
      "Netlinking ciblé & suivi des positions",
    ],
    detailedContent: [
      "Alors que l'Outbound marketing (cold email, prospection directe) apporte des résultats rapides, le SEO (Search Engine Optimization) construit le moteur d'acquisition le plus pérenne et le plus rentable à long terme. Un prospect qui trouve votre site par lui-même en cherchant une solution à son besoin est déjà à moitié convaincu. Notre accompagnement SEO B2B est conçu spécifiquement pour capter ces intentions d'achat.",
      "La première étape consiste à réaliser un audit approfondi : analyse technique de votre site (vitesse, indexation, structure HTML), audit de votre contenu existant et étude comparative de vos concurrents. Nous construisons ensuite votre carte de mots-clés cibles, en privilégiant les requêtes à forte valeur commerciale plutôt que le simple volume de trafic.",
      "Nous structurons votre site en cocon sémantique : des pages services piliers interconnectées à des articles de blog thématiques et des études de cas qui répondent précisément aux questions de vos prospects à chaque étape de leur réflexion. Chaque contenu est rédigé et optimisé avec soin pour plaire à la fois aux moteurs de recherche et à des décideurs exigents.",
      "Côté autorité, nous mettons en place des campagnes de netlinking ciblées pour obtenir des liens (backlinks) depuis des sites référents dans votre secteur. En parallèle, nous suivons mensuellement le positionnement de vos pages sur vos mots-clés stratégiques, le trafic organique généré et surtout le nombre de leads entrants attribuables au SEO.",
      "Le SEO s'associe idéalement avec nos autres leviers : pendant que votre accompagnement SEO monte en puissance sur 3 à 6 mois, nos campagnes de cold emailing et de scraping B2B remplissent votre pipeline immédiatement. Une fois les leads arrivés, notre automatisation sales prend le relais pour garantir un suivi irréprochable. Nous accompagnons la croissance SEO des PME à Marseille, Aix-en-Provence, Toulon et Nice.",
    ],
    relatedCities: [
      { slug: "marseille", label: "Marseille" },
      { slug: "aix-en-provence", label: "Aix-en-provence" },
    ...
    faq: [
      {
        ...
        answer: "Le SEO est un travail de fond. Les premiers signaux (hausse des positions et des impressions) apparaissent généralement entre 2 et 3 mois, et les premiers leads réguliers entre 4 et 6 mois.",
      },
      {
        question: "En quoi le SEO B2B est-il différent du SEO e-commerce ?",
        answer: "Le SEO B2B vise des volumes de recherche souvent plus faibles mais extrêmement qualifiés, avec des cycles de décision plus longs. L'enjeu est d'asseoir son expertise et de capter des décideurs, pas de faire du volume indifférencié.",
      },
      {
        question: "Fournissez-vous la rédaction des contenus ?",
        answer: "Oui. Notre équipe rédige des articles et des pages piliers optimisés SEO et adaptés à votre ton métier, après validation de votre part sur la stratégie et les thématiques.",
      },
      {
        question: "Faut-il refaire mon site web pour faire du SEO ?",
        answer: "Pas nécessairement. Dans la plupart des cas, nous optimisons la structure, le code et le contenu de votre site existant sans repartir de zéro.",
      },
    ],
  },
};