...
export const metadata: Metadata = {
  ...
  description: "Contactez Nana Intelligence pour un audit gratuit de 30 minutes. Agence de Lead Generation B2B, experte en Cold Emailing, Scraping et Automatisation Sales. Obtenez un plan d'action personnalisé.",
  keywords: [
